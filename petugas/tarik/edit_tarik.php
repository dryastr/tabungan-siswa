				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							<input type="hidden" class="form-control" name="id_tabungan" class="form-control" value="<?php echo $data_cek['id_tabungan']; ?>" readonly />
						</div>
					...
					<div class="box-footer">
						...
						<a href="?page=data_tarik" class="btn btn-secondary">Batal</a>
					</div>
				</form>
			</div>
			<!-- /.box -->
